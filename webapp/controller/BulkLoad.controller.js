      ...
      return BaseController.extend(
        "com.intapptics.mdbulkload.controller.BulkLoad",
        {
          ...
          handleUploadComplete: function (oEvent) {
            ...
            self.getView.byId("fu_upload").setVisible(false);
            self.getView.byId("combo_category").setVisible(false);
            self.getView.byId("combo_tablelist").setVisible(false);
          ...
          handleValidateData: function (oEvent) {
            if (self.validateWorkflowId()) {
              ...
              var oDataModel1 = self.getOwnerComponent().getModel("validatedata");
  
              var oModel1 = JSONModel();
              ...
              oDataModel1.read("GDISTempSet", {
                ...
                success: function (oData, oResponse) {
                  ...
                  if (!oModel1.oData.length > 0) {
                    ...
                    oEntry.Futurever = self.futurever;
                    ...
                    oDataModel.create("/InHeaderSet", oEntry, {
                      ...
                      success: function (oData, oResponse) {
                        ...
                        self.getView().byId("tableId").setVisible(true);
          ...
          onInvalidDataExport: function (oEvent) {
            ...
            wb.SeetNames.push("Invalid Data");
            var ws_data = [];
            var length = self
              .getOwnerComponent()
