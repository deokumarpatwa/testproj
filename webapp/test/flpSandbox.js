		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bulk Upload",
									"targetURL": "#comintappticsmdbulkload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comintappticsmdbulkload-display": {
								"semanticObject": "comintappticsmdbulkload",
								"action": "display",
								"description": "A Bulk Upload Application",
								"title": "Bulk Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.intapptics.mdbulkload",
									"url": sap.ui.require.toUrl("com/intapptics/mdbulkload")
								}
							}
						}
					}
